        ...
        toBeDataUrl: function () {
          return {
            compare: function (url) {
              ...
              var message =
                'Expected ' + url + ' to be a valid data url. ' + header + ' is not valid header for data uris';
              return {
                pass: pass,
                message: message,
              };
          ...
          function gotDirectory(entry) {
            ...
            window.resolveLocalFileSystemURL(
              ...
              failed.bind(
                ...
                'window.resolveLocalFileSystemURL - Error resolving directory URL: ' + entry.toURL()
              )
            );
          }
          createDirectory(
      ...
      it('file.spec.23 DirectoryEntry.getDirectory: get Entry for directory that does not exist', function (done) {
        ...
        root.getDirectory(
          ...
          succeed.bind(
            ...
            'root.getDirectory - Error unexpected callback, directory should not exists: ' + dirName
          ),
          fail
        );
      });
        ...
        function getDir(dirEntry) {
          ...
          window.resolveLocalFileSystemURL(
            ...
            failed.bind(
              ...
              'window.resolveLocalFileSystemURL - getDir function - Error resolving directory: ' + dirURI
            )
          );
        }
          ...
          function (directory) {
            ...
            root.getFile(
              ...
              succeed.bind(
                ...
                'root.getFile - Unexpected success callback, file should not exists: ' + dirName
              ),
              fail
            );
          },
            ...
            entry.getDirectory(
              ...
              function (dir) {
                entry.removeRecursively(function () {
                  ...
                  'entry.removeRecursively - Error removing directory recursively : ' + dirName
                ));
              },
          ...
          root.getFile(
            ...
            function (entry) {
              ...
              reader.readEntries(function (entries) {
                ...
                'reader.readEntries - Error during FIRST reading of entries from [root] directory'
              ));
            },
            failed.bind(null, done, 'root.getFile - Error creating file : ' + fileName)
          );
        ...
        root.getDirectory(
          ...
          function (directory) {
            directory.removeRecursively(function () {
              ...
              'directory.removeRecursively - Error removing directory recursively : ' + dirName
            ));
          },
          failed.bind(null, done, 'root.getDirectory - Error creating directory : ' + dirName)
        );
          ...
          function (directory) {
            ...
            directory.copyTo(
              ...
              succeed.bind(
                ...
                'directory.copyTo - Unexpected success callback, it should not copy a directory ' +
                  srcDir +
                  ' into itself'
              ),
              function (error) {
                  ...
                  function (fileEntry) {
                    ...
                    root.getFile(
                      ...
                      succeed.bind(
                        ...
                        'root.getFile - Unexpected success callback, it should not get invalid or moved file: ' + file1
                      ),
                      function (error) {
          ...
          function (entry) {
            ...
            entry.moveTo(
              ...
              succeed.bind(
                ...
                'entry.moveTo - Unexpected success callback, : ' + file1 + ' to root as: ' + file2
              ),
              function (error) {
                expect(error).toBeDefined();
                expect(error).toBeFileError(FileError.ENCODING_ERR);
    ...
    describe('Read method', function () {
      ...
      function writeDummyFile(writeBinary, callback, done, fileContents) {
        ...
        function createWriter(fe) {
          ...
          fileEntry.createWriter(
            writeFile,
            failed.bind(null, done, 'fileEntry.createWriter - Error reading file: ' + fileName)
          );
        }
            ...
            var theWriter,
              write_file = function (fileEntry) {
                ...
                fileEntry.createWriter(function (writer) {
                  ...
                  writer.onerror = failed.bind(
                    null,
                    done,
                    'writer.onerror - Error writing content on file: ' + fileName
                  );
                  writer.write(fileData);
                }, failed.bind(
                  null,
              ...
              function (entry) {
                ...
                entry.copyTo(
                  ...
                  failed.bind(
                    ...
                    'entry.copyTo - Error copying file: ' + file1 + ' to PERSISTENT root as: ' + file2
                  )
                );
              },
        ...
        persistent_root.getFile(
          ...
          function (entry) {
            entry.remove(
              ...
              failed.bind(null, done, 'entry.remove - Error removing file: ' + file2)
            );
          },
          createSourceAndTransfer
        );
              ...
              function (entry) {
                ...
                entry.copyTo(
                  ...
                  failed.bind(
                    ...
                    'entry.copyTo - Error copying file: ' + file1 + ' to TEMPORAL root as: ' + file2
                  )
                );
              },
              ...
              function (entry) {
                ...
                entry.moveTo(
                  ...
                  failed.bind(
                    ...
                    'entry.moveTo - Error moving file: ' + file1 + ' to PERSISTENT root as: ' + file2
                  )
                );
              },
              failed.bind(null, done, 'temp_root.getFile - Error creating file: ' + file1 + 'at TEMPORAL root')
              ...
              function (entry) {
                ...
                entry.moveTo(
                  ...
                  failed.bind(
                    ...
                    'entry.moveTo - Error moving file: ' + file1 + ' to TEMPORAL root as: ' + file2
                  )
                );
              },
              failed.bind(null, done, 'persistent_root.getFile - Error creating file: ' + file1 + 'at PERSISTENT root')
                  ...
                  function () {
                    parent.removeRecursively(function () {
                      root.getDirectory(
                        parentDirName,
                        { create: false },
                        failed.bind(this, done, 'root.getDirectory - unexpected success callback : ' + parentDirName),
                        function () {
                          parent.getFile(
                            nestedFileName,
                            { create: false },
                            failed.bind(this, done, 'getFile - unexpected success callback : ' + nestedFileName),
                            function () {
                              parent.getDirectory(
                                nestedDirName,
                                { create: false },
                    ...
                    function () {
                      root.getDirectory(
                        ...
                        failed.bind(
                          ...
                          'getDirectory - Error getting directory after deleting deletedDirectory : ' + secondDirName
                        )
                      );
                    }
                  );
    ...
    if (cordova.platformId == 'android') {
      describe('content: URLs', function () {
        ...
        it('file.spec.139 copyTo: content /w space and query', function (done) {
          testContentCopy(
            'content://org.apache.cordova.file.testprovider/?name=foo%20bar&realPath=%2Fwww%2Findex.html',
            done
          );
        });
            ...
            resolveLocalFileSystemURL(
              ...
              function (entry) {
                ...
                reader.readEntries(function (entries) {
                  ...
                  'reader.readEntries - Error during reading of entries from assets directory'
                ));
              },
...
exports.defineManualTests = function (contentEl, createActionButton) {
  ...
  div.appendChild(
    document.createTextNode('Results are displayed in yellow status box below with expected results noted under that')
  );
  div.setAttribute('align', 'center');
  contentEl.appendChild(div);
