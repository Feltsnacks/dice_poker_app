...
(function (exports, global) {
  ...
  idb_.getAllEntries = function (fullPath, storagePath, successCallback, errorCallback) {
    ...
    var range = IDBKeyRange.bound(storagePath + DIR_SEPARATOR, storagePath + DIR_OPEN_BOUND, false, true);
    ...
    tx.oncomplete = function (e) {
      results = results.filter(function (val) {
        ...
        if (fullPath === DIR_SEPARATOR && valPartsLen < fullPathPartsLen + 1) {
          ...
          return val;
        } else if (fullPath !== DIR_SEPARATOR && valPartsLen === fullPathPartsLen + 1) {
