...
const presetOptions = [
    ...
    {
        name: Preset.OSS,
        message: 'oss               [an empty workspace with a layout that works best for open-source projects]',
    },
];
const tsVersion = '4.1.5';
const cliVersion = '12.0.4';
const nxVersion = '12.0.4';
...
(function main() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { name, cli, preset, appName, style, linter, nxCloud, } = yield getConfiguration(parsedArgs);
...
function getConfiguration(parsedArgs) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const linter = yield determineLinter(preset, parsedArgs);
...
function determineLinter(preset, parsedArgs) {
...
function createApp(tmpDir, name, packageManager, parsedArgs) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            output_1.output.error({
                title: 'Something went wrong. Rerunning the command with verbose logging.',
            });
        ...
        if (parsedArgs.nxCloud) {
            ...
            child_process_1.execSync(`${pmc.exec} nx g @nrwl/nx-cloud:init --no-analytics`, {
                stdio: [0, 1, 2],
