...
function convertToContact(windowsContact) {
  ...
  for (i = 0; i < windowsContact.locations.size; i++) {
    var address = new ContactAddress(
      null,
      windowsContact.locations[i].category,
      windowsContact.locations[i].unstructuredAddress,
      windowsContact.locations[i].street,
      null,
      windowsContact.locations[i].region,
      windowsContact.locations[i].postalCode,
