    ...
    describe(scenarioList[i] + ': misc legacy tx test(s)', function () {
            ...
            function (tx) {
              ...
              tx.executeSql(
                ...
                function (tx, error) {
                  ...
                  if (isWebSql || !(isAndroid || isWindows || isWP8)) ok(!!error['code'], 'valid error.code exists');
      ...
      describe(scenarioList[i] + ': multiple update test(s)', function () {
        ...
        test_it(suiteName + 'Multiple updates with key', function () {
          var db = openDatabase('MultipleUpdatesWithKey', '1.0', 'Demo', DEFAULT_SIZE);
          ...
          db.transaction(
            function (tx) {
              ...
              tx.executeSql(
                'UPDATE Task SET subject="Send reminder", id="928238b3-a227-418f-aa15-12bb1943c1f2" WHERE id = "928238b3-a227-418f-aa15-12bb1943c1f2"',
                [],
                function (tx, res) {
              ...
              tx.executeSql(
                'UPDATE Task SET subject="Task", id="511e3fb7-5aed-4c1a-b1b7-96bf9c5012e2" WHERE id = "511e3fb7-5aed-4c1a-b1b7-96bf9c5012e2"',
                [],
                function (tx, res) {
                  expect(res.rowsAffected).toEqual(1);
                },
