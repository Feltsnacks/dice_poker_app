  ...
  for (var i = 0; i < scenarioCount; ++i) {
    describe(scenarioList[i] + ': detailed tx error handling test(s)', function () {
      ...
      describe(scenarioList[i] + ': tx error semantics test(s)', function () {
        ...
        it(
          suiteName + 'SKIP SQL CALLBACKS after syntax error with no handler',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                if (isWP8) expect(true).toBe(true);
                // SKIP for now
                else if (isWindows || (isAndroid && isImpl2)) expect(error.code).toBe(0);
                else if (isWebSql && isAndroid) expect(true).toBe(true);
                // SKIP for now
                else expect(error.code).toBe(5);
        ...
        /* found due to investigation of litehelpers/Cordova-sqlite-storage#226: */
        it(
          suiteName + 'SKIP SQL CALLBACKS after syntax error handler returns true',
          function (done) {
        ...
        it(
          suiteName + 'Recover transaction with callbacks after syntax error handler returns false',
          function (done) {
        ...
        it(
          suiteName +
            'syntax error handler returns undefined' +
            (isWebSql ? ' (DEVIATION in WebKit Web SQL implementation)' : ' (Plugin COMPLIANT)'),
          function (done) {
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (ignored, rs) {
                    ...
                    if (!isWebSql) expect(false).toBe(true);
                    isSecondSuccessHandlerCalled = true;
                    expect(rs).toBeDefined();
                  },
                  function (ignored, error) {
              ...
              function (error) {
                ...
                expect(error.code).toBeDefined();
                expect(error.message).toBeDefined();
                if (isWebSql) expect('WebKit Web SQL behavior changed, please update this test').toBe('--');
                expect(isFirstErrorHandlerCalled).toBe(true);
                // Close (plugin only) & finish:
                isWebSql ? done() : db.close(done, done);
              },
        ...
        it(
          suiteName + 'STOP nested transaction if syntax error handler returns true',
          function (done) {
            var db = openDatabase(
              'stop-nested-tx-if-syntax-error-handler-returns-true.db',
              '1.0',
              'Test',
              DEFAULT_SIZE
            );
      ...
      describe(scenarioList[i] + ': other tx error handling test(s)', function () {
        ...
        it(
          suiteName + 'empty transaction (no callback argument) in try-catch block [BOGUS] and then SELECT transaction',
          function (done) {
            ...
            try {
              ...
              if (isWebSql) expect(ex.code).not.toBeDefined();
              else expect(ex.code).toBeDefined();
              expect(ex.message).toBeDefined();

              if (!isWebSql) expect(ex.code).toBe(0); // (SQLite.UNKNOWN_ERR)

              if (!isWebSql) expect(ex.message).toMatch(/transaction expected a function/);
              else if (isAndroid) expect(true).toBe(true);
              // SKIP (for now)
              else expect(ex.message).toMatch(/Not enough arguments/);
            }
        ...
        it(
          suiteName +
            'empty readTransaction (no callback argument) in try-catch block [BOGUS] and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'db.transaction(null) in try-catch block and then SELECT transaction',
          function (done) {
            ...
            try {
              ...
              // SKIP for now
              else expect(ex.message).toMatch(/Argument 1 \('callback'\) to Database\.transaction must be a function/);
            }
        ...
        it(
          suiteName + 'db.readTransaction(null) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + "db.transaction('bogus') in try-catch block and then SELECT transaction",
          function (done) {
        ...
        it(
          suiteName + "db.readTransaction('bogus') in try-catch block and then SELECT transaction",
          function (done) {
        ...
        it(
          suiteName + "db.transaction('') in try-catch block and then SELECT transaction",
          function (done) {
        ...
        it(
          suiteName + "db.readTransaction('') in try-catch block and then SELECT transaction",
          function (done) {
        ...
        it(
          suiteName + 'db.transaction(true) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'db.readTransaction(true) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'db.transaction(false) in try-catch block and then SELECT transaction',
          function (done) {
            ...
            try {
              ...
              if (!isWebSql) expect(ex.code).toBe(0); // (SQLError.UNKNOWN_ERR)
        ...
        it(
          suiteName + 'db.readTransaction(false) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'db.transaction(undefined) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'db.readTransaction(undefined) in try-catch block and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + "transaction with 'SELECT 1' and BOGUS string success callback",
          function (done) {
            ...
            try {
              ...
              if (isAndroid) expect(true).toBe(true);
              // SKIP for now
              else
        ...
        it(
          suiteName + "readTransaction with 'SELECT 1' and BOGUS string success callback",
          function (done) {
        ...
        it(
          suiteName + "transaction with 'SELECT 1' and BOGUS string error callback",
          function (done) {
        ...
        it(
          suiteName + "readTransaction with 'SELECT 1' and BOGUS string error callback",
          function (done) {
        ...
        it(
          suiteName + "transaction with 'SLCT 1' and BOGUS string success callback",
          function (done) {
        ...
        it(
          suiteName + "readTransaction with 'SLCT 1' and BOGUS string success callback",
          function (done) {
        ...
        it(
          suiteName + "transaction with 'SLCT 1' and BOGUS string error callback",
          function (done) {
        ...
        it(
          suiteName + "readTransaction with 'SLCT 1' and BOGUS string error callback",
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // SKIP for now
            if (isWindows) pending('SKIP for Windows due to CRASH');
        ...
        it(
          suiteName + 'empty transaction (no sql statements) and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'empty readTransaction (no sql statements) and then SELECT transaction',
          function (done) {
        ...
        it(
          suiteName + 'transaction.executeSql() with no executeSql arguments WITHOUT try-catch block (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else if (isAndroid) expect(error.message).toMatch(/Cannot .* 'toString' of undefined/);
                else expect(error.message).toMatch(/undefined is not an object \(evaluating 'sql\.toString'\)/);
              ...
              function () {
                ...
                if (isWindows) expect(true).toBe(true);
        ...
        it(
          suiteName + "transaction.executeSql on BOGUS empty SQL string ('')",
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                if (isWP8) expect(true).toBe(true);
                // SKIP for now
                else if (!isWebSql) expect(error.code).toBe(0);
                else expect(error.code).toBe(1);
                ...
                else expect(error.message).toMatch(/could not execute statement \(0 not an error\)/);
        ...
        it(
          suiteName + "readTransaction.executeSql on BOGUS empty SQL string ('')",
          function (done) {
        ...
        it(
          suiteName + "transaction.executeSql on BOGUS ';' SQL statement",
          function (done) {
        ...
        it(
          suiteName + "readTransaction.executeSql on BOGUS ';' SQL statement",
          function (done) {
        ...
        it(
          suiteName + 'transaction.executeSql on BOGUS object',
          function (done) {
        ...
        it(
          suiteName + 'readTransaction.executeSql on BOGUS object',
          function (done) {
        ...
        it(
          suiteName + 'transaction.executeSql with BOGUS array',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"first\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql on BOGUS number 101',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"101\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql on BOGUS number 0',
          function (done) {
            var db = openDatabase('tx-with-number-101-for-sql-statement.db', '1.0', 'Demo', DEFAULT_SIZE);
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"0\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql with null for SQL statement (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                // EXPECTED RESULT:
                if (isWebSql) expect(check1).toBe(true);
                expect(error).toBeDefined();
                expect(error.code).toBeDefined();
                expect(error.message).toBeDefined();

                if (!isWebSql) expect(error.code).toBe(0);
                else expect(error.code).toBe(5);
                ...
                if (isWebSql)
                  ...
                  expect(error.message).toMatch(/Unable to get property 'toString' of undefined or null reference/);
                else if (isAndroid) expect(error.message).toMatch(/Cannot .* 'toString' of null/);
                else expect(error.message).toMatch(/null is not an object \(evaluating 'sql\.toString'\)/);
        ...
        it(
          suiteName + 'transaction.executeSql with true for SQL statement (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"true\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql with false for SQL statement (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"false\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql with Infinity for SQL statement (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"Infinity\": syntax error\)/);
        ...
        it(
          suiteName + 'readTransaction.executeSql with -Infinity for SQL statement (BOGUS)',
          function (done) {
            ...
            db.readTransaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"-\": syntax error\)/);
        ...
        it(
          suiteName + 'transaction.executeSql with NaN for SQL statement (BOGUS)',
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/could not prepare statement \(1 near \"NaN\": syntax error\)/);
        ...
        it(
          suiteName + 'readTransaction.executeSql with NaN for SQL statement (BOGUS)',
          function (done) {
        ...
        it(
          suiteName + 'transaction.executeSql with undefined executeSql argument (BOGUS)',
          function (done) {
        ...
        it(
          suiteName +
            'transaction.executeSql blank string test with callback function for parameter argument array [TBD (WebKit) Web SQL vs plugin]',
          function (done) {
            //if (!isWebSql && !isAndroid && !isWindows && !isWP8) pending('SKIP for iOS plugin'); // TBD may break other tests on certain iOS versions

            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-callback-function-for-arg-array.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'readTransaction.executeSql blank string test with callback function for parameter argument array [TBD (WebKit) Web SQL vs plugin]',
          function (done) {
            //if (!isWebSql && !isAndroid && !isWindows && !isWP8) pending('SKIP for iOS plugin'); // TBD may break other tests on certain iOS versions

            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-callback-function-for-arg-array-read-tx.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName + 'transaction.executeSql with no SQL statement in a try-catch block (BOGUS)',
          function (done) {
            ...
            db.transaction(
              function (transaction) {
                try {
                  ...
                  expect(ex).toBeDefined();
                  if (!isWebSql) expect(ex.code).not.toBeDefined();
                  else if (!isAndroid) expect(ex.code).toBeDefined();
                  expect(ex.message).toBeDefined();

                  if (isWebSql && !isAndroid) expect(ex.code).toBe(12);

                  if (isWP8) expect(true).toBe(true);
                  // SKIP for now
                  else if (isWindows)
                    expect(ex.message).toMatch(/Unable to get property 'toString' of undefined or null reference/);
                  else if (!isWebSql && isAndroid) expect(ex.message).toMatch(/Cannot .* 'toString' of undefined/);
                  else if (!isWebSql)
              ...
              function (error) {
                ...
                // SKIP for now
                  ...
                  expect(error.message).toMatch(/Unable to get property 'toString' of undefined or null reference/);
                else if (!isWebSql && isAndroid) expect(error.message).toMatch(/Cannot .* 'toString' of undefined/);
                else if (!isWebSql)
                  expect(error.message).toMatch(/undefined is not an object \(evaluating 'sql\.toString'\)/);
                else expect(error.message).toMatch(/the SQLTransactionCallback was null or threw an exception/);
        ...
        it(
          suiteName + 'readTransaction.executeSql with no SQL statement in a try-catch block (BOGUS)',
          function (done) {
        ...
        it(
          suiteName +
            'Inline US-ASCII String manipulation test with arguments array="string-value" (BOGUS) in a try-catch block',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-arguments-array-equals-string-value.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
            ...
            db.transaction(
              function (tx) {
                try {
                  ...
                  if (!isWebSql) expect('Plugin behavior changed please update this test').toBe('--');
                  expect(ex).toBeDefined();
                  if (!isAndroid) expect(ex.code).toBeDefined();
                  expect(ex.message).toBeDefined();
                  if (!isAndroid) expect(ex.code).toBe(17);
                  throw ex;
                }
              },
              function (error) {
        ...
        it(
          suiteName +
            'Inline US-ASCII String manipulation test with arguments array="string-value" (BOGUS) in a try-catch block read tx',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-arguments-array-equals-string-value-read-tx.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'Inline US-ASCII String manipulation test with arguments array=false (BOGUS) in a try-catch block',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-arguments-array-equals-false.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'Inline US-ASCII String manipulation test with arguments array=true (BOGUS) in a try-catch block read tx',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-arguments-array-equals-true-read-tx.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'Inline US-ASCII blank string test with arguments array=function (BOGUS) in a try-catch block [TBD (WebKit) Web SQL vs plugin]',
          function (done) {
            //if (!isAndroid && !isWindows && !isWP8) pending('SKIP for iOS'); // TBD may break other tests on certain iOS versions

            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-arguments-array-equals-true.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'Inline US-ASCII blank string test with arguments array=function (BOGUS) in a try-catch block read tx [TBD (WebKit) Web SQL vs plugin]',
          function (done) {
            //if (!isAndroid && !isWindows && !isWP8) pending('SKIP for iOS'); // TBD may break other tests on certain iOS versions
        ...
        it(
          suiteName +
            "transaction.executeSql('SELECT 1') with string for success callback in a try-catch block (BOGUS)",
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                if (isWP8) expect(true).toBe(true);
                // SKIP for now
                else if (isWindows) expect(error.message).toMatch(/Function expected/);
                else if (!isWebSql) expect(error.message).toMatch(/is not a function/);
                else expect(error.message).toMatch(/the SQLTransactionCallback was null or threw an exception/);
        ...
        it(
          suiteName +
            "readTransaction.executeSql('SELECT 1') with string for success callback in a try-catch block (BOGUS)",
          function (done) {
        ...
        it(
          suiteName + "transaction.executeSql('SLCT 1') with string for success callback in a try-catch block (BOGUS)",
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                if (isWP8) expect(true).toBe(true);
                // SKIP for now
                else if (!isWebSql && !isWindows && !(isAndroid && isImpl2)) expect(error.code).toBe(5);
                else expect(error.code).toBe(0);
        ...
        it(
          suiteName +
            "readTransaction.executeSql('SLCT 1') with string for success callback in a try-catch block (BOGUS)",
          function (done) {
        ...
        it(
          suiteName + "transaction.executeSql('SELECT 1') with string for error callback in a try-catch block (BOGUS)",
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                ...
                if (!isWebSql) expect(error.message).toMatch(/is not a function/);
                else expect(error.message).toMatch(/the SQLTransactionCallback was null or threw an exception/);
        ...
        it(
          suiteName +
            "readTransaction.executeSql('SELECT 1') with string for error callback in a try-catch block (BOGUS)",
          function (done) {
        ...
        it(
          suiteName + "transaction.executeSql('SLCT 1') with string for error callback in a try-catch block (BOGUS)",
          function (done) {
        ...
        it(
          suiteName +
            "readTransaction.executeSql('SLCT 1') with string for error callback in a try-catch block (BOGUS)",
          function (done) {
        ...
        it(
          suiteName + 'Error recovery for transaction with object for SQL statement',
          function (done) {
            ...
            db.transaction(
              function (tx) {
                tx.executeSql(
                  { key1: 'value1', key2: 2 },
                  [],
                  function (tx_ignored, rs_ignored) {
                    // NOT EXPECTED:
                    expect(false).toBe(true);
                  },
        ...
        it(
          suiteName + 'Error recovery for transaction with array for SQL statement',
          function (done) {
