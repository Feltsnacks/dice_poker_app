...
var mytests = function () {
  describe('Plugin - BASIC sqlitePlugin.openDatabase parameter check test(s)', function () {
    ...
    it(
      suiteName + 'Open plugin database with Web SQL parameters (REJECTED with exception)',
      function (done) {
        try {
          var db = window.sqlitePlugin.openDatabase(
            'open-with-web-sql-parameters-test.db',
            '1.0',
            'Demo',
            DEFAULT_SIZE
          );
    ...
    it(
      suiteName + 'check that db name is really a string',
      function (done) {
        var p1 = { name: 'my.db.name', location: 1 };
        try {
          window.sqlitePlugin.openDatabase(
            { name: p1, location: 'default' },
            function (db) {
              // NOT EXPECTED:
              expect(false).toBe(true);
              done();
    ...
    it(
      suiteName + 'Open with no location setting (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            { name: 'open-with-no-location-setting.db' },
            function (db) {
              // NOT EXPECTED:
              expect(false).toBe(true);
    ...
    it(
      suiteName + 'Open with both location & iosDatabaseLocation settings (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
    ...
    it(
      suiteName + 'Open with location: -1 (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            { name: 'open-with-location--1.db', location: -1 },
            function (db) {
              // NOT EXPECTED:
              expect(false).toBe(true);
    ...
    it(
      suiteName + 'Open with iosDatabaseLocation: -1 (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
    ...
    it(
      suiteName + 'Open with location: 3 (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            { name: 'open-with-location-3.db', location: 3 },
            function (db) {
              // NOT EXPECTED:
              expect(false).toBe(true);
    ...
    it(
      suiteName + 'Open with iosDatabaseLocation: 3 (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
    ...
    it(
      suiteName + "Open with location: 'bogus' (REJECTED with exception)",
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
    ...
    it(
      suiteName + "Open with iosDatabaseLocation: 'bogus' (REJECTED with exception)",
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
    ...
    it(
      suiteName + 'Open with location: null (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            { name: 'open-with-location-null.db', location: null },
            function (db) {
              // NOT EXPECTED:
              expect(false).toBe(true);
    ...
    it(
      suiteName + 'Open with iosDatabaseLocation: null (REJECTED with exception)',
      function (done) {
        try {
          window.sqlitePlugin.openDatabase(
            {
  ...
  describe('Plugin: db open-close-delete test(s)', function () {
    describe('Plugin - BASIC sqlitePlugin.deleteDatabase parameter check test(s)', function () {
      ...
      it(
        suiteName + 'check that sqlitePlugin.deleteDatabase db name is really a string',
        function (done) {
          var p1 = { name: 'my.db.name', location: 1 };
          try {
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with no location setting (REJECTED with exception)',
        function (done) {
          try {
            // FUTURE TBD test without callbacks?
            window.sqlitePlugin.deleteDatabase(
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with string parameter (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              'my.db',
      ...
      it(
        suiteName +
          'sqlitePlugin.deleteDatabase with both location & iosDatabaseLocation settings (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', location: 'default', iosDatabaseLocation: 2 },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with location: -1 (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', location: -1 },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with iosDatabaseLocation: -1 (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', iosDatabaseLocation: -1 },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with location: 3 (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', location: 3 },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + 'sqlitePlugin.deleteDatabase with iosDatabaseLocation: 3 (REJECTED with exception)',
        function (done) {
          try {
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', iosDatabaseLocation: 3 },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + "sqlitePlugin.deleteDatabase with location: 'bogus' (REJECTED with exception)",
        function (done) {
          try {
            // FUTURE TBD test without callbacks?
            //window.sqlitePlugin.deleteDatabase({ name: 'my.db', location: 'bogus' }); // callbacks ignored
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', location: 'bogus' },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
      ...
      it(
        suiteName + "sqlitePlugin.deleteDatabase with iosDatabaseLocation: 'bogus' (REJECTED with exception)",
        function (done) {
          try {
            // FUTURE TBD test without callbacks?
            //window.sqlitePlugin.deleteDatabase({ name: 'my.db', iosDatabaseLocation: 'bogus' }); // callbacks ignored
            window.sqlitePlugin.deleteDatabase(
              { name: 'my.db', iosDatabaseLocation: 'bogus' },
              function () {
                // NOT EXPECTED:
                expect(false).toBe(true);
    ...
    for (var i = 0; i < pluginScenarioCount; ++i) {
      describe(pluginScenarioList[i] + ': basic plugin open-close test(s)', function () {
        ...
        it(
          suiteName + ' REPRODUCE BUG: close DB in db.executeSql() callback',
          function (done) {
    ...
    describe('repeated open/close/delete test(s)', function () {
      ...
      test_it(suiteName + ' immediate close, then delete then re-open allows subsequent queries to run', function () {
        ...
        db1.close(
          function () {
            deleteDatabase(
              { name: dbName, iosDatabaseLocation: 'Documents' },
              function () {
                openDatabase(
                  { name: dbName, iosDatabaseLocation: 'Documents' },
                  function (db) {
      ...
      test_it(
        suiteName + ' close (after open cb), then delete then re-open allows subsequent queries to run',
        function () {
          ...
          openDatabase(
            { name: dbName, iosDatabaseLocation: 'Library' },
            function (db1) {
              db1.close(
                function () {
                  deleteDatabase(
                      ...
                      function () {
                        ...
                        sqlitePlugin.deleteDatabase(
                          ...
                          function (error) {
                            ok(
                              false,
                              'expected delete 5/5 error callback not to be called for an open database' + error
                            );
                            start(1);
                          }
                        );
