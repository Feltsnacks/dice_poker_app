...
test('chainable', function () {
  ...
  same(
    ...
    store,
    'should be chainable (return itself)'
  );
});
...
test('shorthand callback syntax', function () {
  ...
  store.all(
    'ok(true, "shorthand syntax callback gets evaled"); same(this, store, "`this` should be scoped to the Lawnchair instance"); QUnit.start();'
  );
