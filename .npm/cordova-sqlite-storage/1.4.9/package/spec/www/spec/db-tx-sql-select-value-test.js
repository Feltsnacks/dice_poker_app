...
var mytests = function () {
  for (var i = 0; i < scenarioCount; ++i) {
    describe(scenarioList[i] + ': tx sql select value results test(s)', function () {
      ...
      it(
        suiteName + 'US-ASCII String manipulation results test',
        function (done) {
      ...
      if (isAndroid)
        it(suiteName + 'Android ICU-UNICODE string manipulation test', function (done) {
          if (isWebSql && /Android [1-4]/.test(navigator.userAgent))
            pending('SKIP for Android versions 1.x-4.x Web SQL');
      ...
      it(
        suiteName + 'SELECT TYPEOF(?) with ["abc"] parameter argument',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT TYPEOF(?) as myresult', [null], function (ignored, rs) {
                ...
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('text');
      ...
      it(
        suiteName + "SELECT TYPEOF('') (INLINE empty string) parameter argument",
        function (done) {
      ...
      it(
        suiteName + "SELECT UPPER('') (INLINE empty string) parameter argument",
        function (done) {
      ...
      it(
        suiteName + "SELECT '' (INLINE empty string) parameter argument",
        function (done) {
          var db = openDatabase('SELECT-UPPER-with-inline-empty-TEXT-string-argument.db');
          expect(db).toBeDefined();
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [null] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT ? with [null] parameter argument [returns text in case of androidDatabaseImplementation: 2; BROKEN for Windows]',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [null], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('');
                else expect(rs.rows.item(0).myresult).toBe(null);
                done();
              });
            },
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [undefined] parameter argument [returns text in case of Android (WebKit) Web SQL or androidDatabaseImplementation: 2; BROKEN for Windows]',
        function (done) {
            ...
            function (error) {
              ...
              if (isWindows) {
                ...
                expect(error.message).toMatch(
                  /a statement with no error handler failed: Unsupported argument type: undefined/
                );
                return done();
              }
      ...
      it(
        suiteName +
          'SELECT ? with [undefined] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          if (isWP8) pending('SKIP for WP8'); // SKIP for now
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [undefined], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (isWebSql && isAndroid) expect(rs.rows.item(0).myresult).toBe('undefined');
                else if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('');
                else expect(rs.rows.item(0).myresult).toBe(null);
                done();
              });
            },
      ...
      it(
        suiteName + 'SELECT TYPEOF(101) INLINE',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(101) INLINE',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [101] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT TYPEOF(?) as myresult', [101], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (isWebSql || isMac || isWKWebView) expect(rs.rows.item(0).myresult).toBe('real');
                else if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('text');
      ...
      it(
        suiteName +
          'SELECT ABS(?) with [101] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ? with [101] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [101], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('101');
      ...
      it(
        suiteName +
          'SELECT ? with [-101] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [123.456] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(?) with [123.456] parameter argument',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT ? with [123.456] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [123.456], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('123.456');
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [1234567890123] (BIG INTEGER) parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(?) with [1234567890123] (BIG INTEGER) parameter argument',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT ? with [1234567890123] (BIG INTEGER) parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [1234567890123], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('1234567890123');
                else expect(rs.rows.item(0).myresult).toBe(1234567890123);
                done();
              });
            },
            function (error) {
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [1234567890123.4] (BIG REAL) parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(?) with [1234567890123.4] (BIG REAL) parameter argument',
        function (done) {
      ...
      it(
        suiteName +
          'SELECT ? with [1234567890123.4] (BIG REAL) parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
          var db = openDatabase('SELECT-TYPEOF-1234567890123.4.db');
          expect(db).toBeDefined();
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [1234567890123.4], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('1.2345678901234E12');
                else expect(rs.rows.item(0).myresult).toBe(1234567890123.4);
                done();
              });
            },
            function (error) {
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [0] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(?) with [0] parameter argument',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ? with [0] parameter argument',
        function (done) {
          ...
          db.transaction(
            function (tx) {
              tx.executeSql('SELECT ? as myresult', [0], function (ignored, rs) {
                ...
                expect(rs.rows).toBeDefined();
                expect(rs.rows.length).toBe(1);
                if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('0');
      ...
      it(
        suiteName +
          'SELECT TYPEOF(?) with [0.0] parameter argument [returns text in case of androidDatabaseImplementation: 2]',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ABS(?) with [0.0] parameter argument',
        function (done) {
      ...
      it(
        suiteName + 'SELECT ? with [0.0] parameter argument',
        function (done) {
      ...
      describe(suiteName + 'Infinity/NaN value test(s)', function () {
        ...
        it(
          suiteName +
            "SELECT ABS(?) with '9e999' (Infinity) parameter argument" +
            (!isWebSql && isAndroid ? ' [Android PLUGIN BROKEN: result with missing row]' : ''),
          function (done) {
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql('SELECT ABS(?) AS myresult', ['9e999'], function (ignored, rs) {
                  ...
                  if (!isWebSql && !isWindows && isAndroid) expect(rs.rows.length).toBe(0);
                  else expect(rs.rows.length).toBe(1);

                  if (isWebSql || isWindows || isMac) expect(rs.rows.item(0).myresult).toBe(Infinity);
        ...
        it(
          suiteName +
            "SELECT -ABS(?) with '9e999' (Infinity) parameter argument" +
            (!isWebSql && isAndroid ? ' [Android PLUGIN BROKEN: missing result]' : ''),
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // (no callback received)
            if (!isWebSql && !isAndroid && !isWindows && !isWP8) pending('SKIP for iOS/macOS plugin due to CRASH');
        ...
        it(
          suiteName + "SELECT UPPER(ABS(?)) with ['9e999'] (Infinity) parameter argument (reference test)",
          function (done) {
        ...
        it(
          suiteName + "SELECT LOWER(-ABS(?)) with ['9e999'] (Infinity) parameter argument (reference test)",
          function (done) {
            var db = openDatabase(
              'SELECT-LOWER-minus-ABS-Infinite-parameter-results-test.db',
              '1.0',
              'Test',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'SELECT LOWER(?) with [Infinity] parameter argument [Android/iOS Plugin BROKEN: result with null value]',
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // SKIP for now
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql('SELECT LOWER(?) AS myresult', [Infinity], function (ignored, rs) {
                  ...
                  if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('');
                  else if (!isWebSql && !isWindows && !isMac) expect(rs.rows.item(0).myresult).toBe(null);
                  else expect(rs.rows.item(0).myresult).toBe('inf');
        ...
        it(
          suiteName +
            'SELECT UPPER(?) with [-Infinity] parameter argument [Android/iOS Plugin BROKEN: result with null value]',
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // SKIP for now
        ...
        it(
          suiteName +
            'SELECT TYPEOF(?) with [Infinity] parameter argument [Android/iOS Plugin BROKEN: reports null type]',
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // SKIP for now
        ...
        it(
          ...
          function (done) {
            ...
            var db = openDatabase(
              'SELECT-TYPEOF-minus-Infinite-parameter-results-test.db',
              '1.0',
              'Test',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'SELECT (?) with Infinity parameter argument [Android/iOS Plugin BROKEN: result with null value; CRASH on macOS]',
          function (done) {
            if (isWP8) pending('SKIP for WP8'); // SKIP for now
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql('SELECT (?) AS myresult', [Infinity], function (ignored, rs) {
                  ...
                  // Android/iOS plugin issue
                  if (!isWebSql && isAndroid && isImpl2) expect(rs.rows.item(0).myresult).toBe('');
                  else if (!isWebSql && !isWindows) expect(rs.rows.item(0).myresult).toBe(null);
                  else expect(rs.rows.item(0).myresult).toBe(Infinity);
        ...
        it(
          suiteName +
            "Infinity/NaN reference test: SELECT ABS(?)-ABS(?) with '9e999' (Infinity) parameter argument values",
          function (done) {
            var db = openDatabase(
              'SELECT-ABS-minus-ABS-with-Infinite-parameter-values-test.db',
              '1.0',
              'Test',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName +
            'Infinity/NaN test: SELECT (?-?) with Infinity parameter argument values [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]',
          function (done) {
        ...
        it(
          suiteName +
            'Infinity/NaN test: SELECT (?+?) with [Infinity, -Infinity] parameter argument values [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]',
          function (done) {
            var db = openDatabase(
              'SELECT-sum-with-Infinite-and-minus-Infinity-parameter-values-test.db',
              '1.0',
              'Test',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName + 'NaN reference test: SELECT (1/0)',
          function (done) {
        ...
        it(
          suiteName +
            'SELECT UPPER(?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]',
          function (done) {
        ...
        it(
          suiteName +
            'SELECT TYPEOF(?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]',
          function (done) {
        ...
        it(
          suiteName +
            'SELECT (?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]',
          function (done) {
      ...
      it(
        suiteName + 'String test with array parameter value including undefined/Infinity/NaN values',
        function (done) {
          var db = openDatabase('String-test-with-array-parameter-value.db', '1.0', 'Demo', DEFAULT_SIZE);

          db.transaction(function (tx) {
            tx.executeSql(
              'SELECT UPPER(?) AS upper_result',
              [['a', undefined, 'b', Infinity, 'c', -Infinity, 'd', NaN, 'e']],
              function (ignored, rs) {
      ...
      describe(suiteName + 'Inline BLOB value SELECT result tests', function () {
        it(
          suiteName + "SELECT LOWER(X'40414243')",
          function (done) {
            ...
            db.transaction(
              ...
              function (error) {
                if (!isWebSql && isAndroid && isImpl2) {
                  ...
                  expect(error.code).toBe(0);
                  expect(error.message).toMatch(
                    /error callback did not return false: unknown error.*code 0.*Unable to convert BLOB to string/
                  );
                } else {
                  // NOT EXPECTED:
                  expect(false).toBe(true);
