  ...
  for (var i = 0; i < scenarioCount; ++i) {
    describe(scenarioList[i] + ': tx string test(s)', function () {
      ...
      describe(suiteName + 'basic string binding/manipulation tests', function () {
        it(
          suiteName + 'Inline US-ASCII String manipulation test with empty ([]) parameter list',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-empty-parameter-list.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName + 'Inline US-ASCII String manipulation test with null parameter list',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-null-parameter-list.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName + 'Inline US-ASCII String manipulation test with undefined parameter list',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-undefined-parameter-list.db',
              '1.0',
              'Demo',
              DEFAULT_SIZE
            );
        ...
        it(
          suiteName + 'US-ASCII String binding test',
          function (done) {
        ...
        it(
          suiteName + 'tx.executeSql(new String(sql))',
          function (done) {
        ...
        it(
          suiteName + 'String encoding test with UNICODE \\u0000',
          function (done) {
        ...
        it(
          suiteName + 'String vertical tab test',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] UNICODE characters not working with WP(8)
        ...
        it(
          suiteName + 'String form feed test',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] UNICODE characters not working with WP(8)
        ...
        it(
          suiteName + 'String backspace test',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] UNICODE characters not working with WP(8)
        ...
        it(
          suiteName +
            'Inline emoji string manipulation test: SELECT UPPER("a\\uD83D\\uDE03.") [\\u1F603 SMILING FACE (MOUTH OPEN)]',
          function (done) {
        ...
        it(
          suiteName + 'Inline emoji HEX test: SELECT HEX("@\\uD83D\\uDE03!") [\\u1F603 SMILING FACE (MOUTH OPEN)]',
          function (done) {
        ...
        it(
          suiteName +
            "Inline BLOB with emoji string manipulation test: SELECT LOWER(X'41F09F9883') [A\uD83D\uDE03] [\\u1F603 SMILING FACE (MOUTH OPEN)]",
          function (done) {
        ...
        it(
          suiteName +
            'emoji SELECT HEX(?) parameter value test: "@\\uD83D\\uDE03!" [\\u1F603 SMILING FACE (MOUTH OPEN)]',
          function (done) {
            if (isWP8) pending('BROKEN for WP8');
            if (isAndroid && !isWebSql && !isImpl2) pending('BROKEN for Android (default sqlite-connector version)');
            if (isWindows) pending('BROKEN for Windows');
        ...
        it(
          suiteName + 'UNICODE \\u2028 line separator string length',
          function (done) {
        ...
        it(
          suiteName + ' handles UNICODE \\u2028 line separator correctly [string test]',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] UNICODE characters not working with WP(8)
        ...
        // - cordova/cordova-discuss#57 (issue with cordova-android)
        it(
          suiteName + 'UNICODE \\u2029 paragraph separator string length',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] Certain UNICODE characters not working with WP(8)
        ...
        it(
          suiteName + ' handles UNICODE \\u2029 paragraph separator correctly [string test]',
          function (done) {
            if (isWP8) pending('BROKEN for WP(8)'); // [BUG #202] UNICODE characters not working with WP(8)
            if (!isWebSql && isAndroid) pending('BROKEN for Android plugin (cordova-android 6.x'); // see cordova/cordova-discuss#57
            if (!isWebSql && !isAndroid && !isWindows && !isWP8) pending('BROKEN for iOS/macOS plugin'); // [BUG #147] (no callback received)
        ...
        it(
          suiteName + 'UTF-8 string binding test',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)');
        ...
        it(
          suiteName + 'Double-quote string test',
          function (done) {
        ...
        it(
          suiteName + 'Double-quote string binding test',
          function (done) {
        ...
        it(
          suiteName + 'Backslash string test',
          function (done) {
        ...
        it(
          suiteName + 'Backslash string binding test',
          function (done) {
      ...
      describe(suiteName + 'string test with non-primitive parameter values', function () {
        it(
          suiteName + 'String test with array parameter value',
          function (done) {
        ...
        it(
          suiteName + 'String test with new String object',
          function (done) {
        ...
        it(
          suiteName + 'String test with custom object parameter value',
          function (done) {
            // MyCustomParameterObject "class":
            function MyCustomParameterObject() {}
            MyCustomParameterObject.prototype.toString = function () {
              return 'toString result';
            };
            MyCustomParameterObject.prototype.valueOf = function () {
      ...
      describe(suiteName + 'string test with [non-primitive] values for SQL', function () {
        it(
          suiteName + 'String test with new String for SQL',
          function (done) {
        ...
        it(
          suiteName + 'String test with custom object for SQL',
          function (done) {
            // MyCustomObject "class":
            function MyCustomObject() {}
            MyCustomObject.prototype.toString = function () {
              return "SELECT UPPER('Alice') as u1";
            };
            MyCustomObject.prototype.valueOf = function () {
              return "SELECT UPPER('Betty') as u1";
            };
      ...
      describe(suiteName + 'string test with dynamically changing objects', function () {
        it(
          suiteName + 'String test with dynamically changing object for SQL',
          function (done) {
        ...
        it(
          suiteName + 'String test with dynamically changing object parameter arg value',
          function (done) {
      ...
      describe(suiteName + 'string test with Array "subclass" for SQL parameter arg values array', function () {
        it(
          suiteName +
            'SELECT UPPER(?) AS upper1, UPPER(?) AS upper2 with "naive" Array subclass (constructor NOT explicitly set) as value arguments array',
          function (done) {
        ...
        it(
          suiteName +
            'SELECT UPPER(?) AS upper1, UPPER(?) AS upper2 with "naive" Array subclass (constructor explicitly set to subclasss) as value arguments array [SQL argument values IGNORED by plugin]',
          function (done) {
        ...
        xit(
          suiteName + 'Blank string test with null/undefined callback functions',
          function (done) {
            var db = openDatabase(
              'Inline-US-ASCII-string-test-with-undefined-parameter-list.db',
              '1.0',
      ...
      describe(suiteName + 'BLOB string test(s)', function () {
        it(
          suiteName + "SELECT HEX(X'010203') [BLOB value test]",
          function (done) {
