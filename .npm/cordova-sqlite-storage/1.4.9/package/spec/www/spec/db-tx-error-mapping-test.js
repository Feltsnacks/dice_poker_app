  ...
  for (var i = 0; i < scenarioCount; ++i) {
    ...
    describe(
      ...
      function () {
        ...
        it(
          suiteName + 'syntax error: command with misspelling',
          function (done) {
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    if (isWindows || (isAndroid && isImpl2)) expect(error.code).toBe(0);
              ...
              function (error) {
                ...
                if (isWindows || isWebSql || (isAndroid && isImpl2)) expect(error.code).toBe(0);
                else expect(error.code).toBe(5);
                ...
                else expect(error.message).toMatch(/error callback did not return false.*syntax error/);
        ...
        it(
          suiteName + 'INSERT syntax error [VALUES in the wrong place] with a trailing space',
          function (done) {
        ...
        it(
          suiteName + 'constraint violation',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    if (isWebSql && !isAndroid) expect(true).toBe(true);
                    // SKIP for iOS (WebKit) Web SQL
                    else if (isWindows) expect(error.code).toBe(0);
                    else expect(error.code).toBe(6);
                    ...
                    else if (isWebSql) expect(error.message).toMatch(/constr?aint fail/);
                    else if (isWindows) expect(error.message).toMatch(/SQLite3 step error result code: 1/);
                    else if (isAndroid && !isImpl2)
                      expect(error.message).toMatch(/sqlite3_step failure: UNIQUE constraint failed: test_table\.data/);
                    else if (isAndroid && isImpl2) expect(error.message).toMatch(/constraint failure/);
                    else expect(error.message).toMatch(/UNIQUE constraint failed: test_table\.data/);
              ...
              function (error) {
                ...
                if (isWindows || isWebSql) expect(error.code).toBe(0);
                else expect(error.code).toBe(6);
                ...
                else expect(error.message).toMatch(/error callback did not return false.*constraint fail/);
        ...
        it(
          suiteName + 'SELECT uper("Test") (misspelled function name) [INCORRECT error code WebKit Web SQL & plugin]',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    else if (isAndroid && isImpl2) expect(error.message).toMatch(/no such function: uper.*code 1/);
              ...
              function (error) {
                ...
                if (isWebSql || isWindows || (isAndroid && isImpl2)) expect(error.code).toBe(0);
                else expect(error.code).toBe(5);
                ...
                else expect(error.message).toMatch(/error callback did not return false.*no such function: uper/);
        ...
        it(
          suiteName + 'SELECT FROM bogus table (other database error) [INCORRECT error code WebKit Web SQL & plugin]',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    else if (isAndroid && isImpl2) expect(error.message).toMatch(/no such table: BogusTable.*code 1/);
                    else expect(error.message).toMatch(/no such table: BogusTable/);
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/error callback did not return false.*no such table: BogusTable/);
        ...
        it(
          suiteName + 'INSERT missing column [INCORRECT error code WebKit Web SQL & plugin]',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
              ...
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    else expect(error.message).toMatch(/table test_table has 2 columns but 1 values were supplied/);
        ...
        it(
          suiteName + 'INSERT wrong column name [INCORRECT error code WebKit Web SQL & plugin]',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  'INSERT INTO test_table (wrong_column) VALUES (?)',
                  ['abcdef'],
                  function (tx) {
                    // NOT EXPECTED:
                    expect(false).toBe(true);
                  ...
                  function (tx, error) {
                    ...
                    else expect(error.message).toMatch(/table test_table has no column named wrong_column/);
        ...
        it(
          suiteName +
            'CREATE VIRTUAL TABLE USING bogus module (other database error) [INCORRECT error code WebKit Web SQL & plugin]',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
            ...
            db.transaction(
              function (tx) {
                ...
                tx.executeSql(
                  ...
                  function (tx, error) {
                    ...
                    else if (isAndroid && isImpl2) expect(error.message).toMatch(/no such module: bogus.*code 1/);
                    else expect(error.message).toMatch(/no such module: bogus/);
              ...
              function (error) {
                ...
                else expect(error.message).toMatch(/error callback did not return false.*no such module: bogus/);
        ...
        it(
          suiteName + 'transaction.executeSql syntax error (command with misspelling) with no SQL error handler',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
        ...
        it(
          suiteName + 'transaction.executeSql constraint violation with no SQL error handler',
          function (done) {
            if (isWP8) pending('SKIP for WP(8)'); // FUTURE TBD
