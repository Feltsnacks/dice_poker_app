  ...
  for (var i = 0; i < scenarioCount; ++i) {
    describe(scenarioList[i] + ': tx sql results test(s)', function () {
      ...
      if (!isWebSql)
        ...
        it(
          suiteName + 'Multi-row INSERT with parameters - NOT supported by Web SQL',
          function (done) {
      ...
      if (!isWebSql)
        // NOT covered by Web SQL standard:
        it(
          suiteName + 'INSERT statement list (NOT covered by Web SQL standard) - Plugin BROKEN',
          function (done) {
      ...
      if (!isWebSql)
        // NOT covered by Web SQL standard:
        it(
          suiteName + 'First result from SELECT statement list - NOT covered by Web SQL standard',
          function (done) {
            ...
            db.transaction(function (tx) {
              // NOT supported by Web SQL:
              tx.executeSql(
                'SELECT UPPER (?) AS upper1; SELECT 1',
                ['Test string'],
      ...
      it(
        suiteName + 'BLOB inserted as a literal',
        function (done) {
      ...
      it(
        suiteName + "SELECT abs('9e999') (Infinity) result test",
        function (done) {
