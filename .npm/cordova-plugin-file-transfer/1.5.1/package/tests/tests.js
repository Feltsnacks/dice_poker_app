      ...
      describe('download', function () {
        ...
        it(
          ...
          function (done) {
            ...
            var downloadFail = function (error) {
              var result =
                error.code === FileTransferError.ABORT_ERR || error.code === FileTransferError.CONNECTION_ERR
                  ? true
                  : false;
              if (!result) {
                fail(
        ...
        it(
          ...
          function (done) {
            ...
            this.transfer.download(
              imageURL + '?q=' + lastModified.getTime(),
              this.localFilePath,
              downloadWin,
              downloadFail,
              null,
        ...
        it(
          ...
          function (done) {
            ...
            specContext.transfer.download(
              imageURL + '?q=' + lastModified.getTime(),
              specContext.localFilePath,
              function () {
                specContext.transfer.download(
                  imageURL + '?q=' + (lastModified.getTime() + 1),
                  specContext.localFilePath,
                  httpWin,
                  downloadFail,
                  null,
